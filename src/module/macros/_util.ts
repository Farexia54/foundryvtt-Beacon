 ...
 */
export function getMacroSpeaker(a_id?: string | BeaconActor): BeaconActor | undefined {
  ...
  let actor: BeaconActor | undefined;
...
export function ownedItemFromString(i: string, actor: BeaconActor): BeaconItem | null {
  // Get the item
